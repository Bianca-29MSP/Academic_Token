...
import (
	...
	modulev1 "academictoken/api/academictoken/student/module"
...
func (AppModuleBasic) RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	// Most modules don't need amino codec registration anymore
	// Comment out if types.RegisterCodec doesn't exist
...
// ----------------------------------------------------------------------------
// App Wiring Setup (for DI - not used in manual setup)
// ----------------------------------------------------------------------------
...
func ProvideModule(in ModuleInputs) ModuleOutputs {
	...
	return ModuleOutputs{StudentKeeper: k, Module: m}
}
