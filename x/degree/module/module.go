...
// Manual construction function (used instead of DI)
func NewManualAppModule(
	cdc codec.Codec,
	degreeKeeper keeper.Keeper,
	accountKeeper types.AccountKeeper,
	bankKeeper types.BankKeeper,
) AppModule {
	return NewAppModule(cdc, degreeKeeper, accountKeeper, bankKeeper)
}
